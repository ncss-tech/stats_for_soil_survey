...
_an approach/philosophy for data analysis that employs a variety of techniques (mostly  graphical) to maximize:_  
...
_If we need a short suggestion of what exploratory data analysis is, I would suggest that_  
...
```{r, eval=FALSE}
sand <- read.table("sand_example.csv", header = TRUE, sep=",")
```
...
![R GUI image](ch4jpg/ch4_fig1.jpg)  

R will return TRUE if there is a missing value within a given row and column or FALSE if there is not. In our sand example, there were no missing values, so R returned all combinations as FALSE.  

An example with missing data would look like:  

![R GUI image](ch4jpg/ch4_fig2.jpg)  
...
![R GUI image](ch4jpg/ch4_fig3.jpg)  
...
![R GUI image](ch4jpg/ch4_fig4.jpg)  
...
![R GUI image](ch4jpg/ch4_fig5.jpg)  
...
![R GUI image](ch4jpg/ch4_fig6.jpg)  Figure 1. Normal Distribution  
...
![R GUI image](ch4jpg/ch4_fig7.jpg)  Figure 2. Skewed example 1  

![R GUI image](ch4jpg/ch4_fig8.jpg)  Figure 3. Skewed example 2  
...
Using the “sand_example.csv” file as the sample data set, review the histogram command from Chapter 1. Remember to use the read.table command and create the “sand” data object in R. The next command will create a histogram with 12 bins:  
```{r, eval=FALSE}
...
![R GUI image](ch4jpg/ch4_fig9.jpg)  Figure 4. Histogram with 12 bins  

The next command will create a histogram with 5 bins:  

```{r, eval=FALSE}
hist(sand$sand, freq=TRUE, breaks=5, xlim = c(15, 40), main = "Histogram of Sand", sub = "with 5 bins", col ="lightblue", ylab = "Counts", xlab = "Total Sand")
```

![R GUI image](ch4jpg/ch4_fig10.jpg)  Figure 5. Histogram with 5 bins  
...
![R GUI image](ch4jpg/ch4_fig11.jpg)  Figure 6. The Kernel density plot depicts a smoothed line of the distribution  
...
![R GUI image](ch4jpg/ch4_fig12.jpg)  
...
**Mean** - The arithmetic average all are familiar with, formally expressed as:![R GUI image](ch4jpg/ch4_fig13.jpg) which means sum all X values in the sample and divide by the number of samples. It is assumed that all references in this document refer to samples rather than a population.  
...
![R GUI image](ch4jpg/ch4_fig14.jpg)  
...
![R GUI image](ch4jpg/ch4_fig15.jpg)  
...
![R GUI image](ch4jpg/ch4_fig16.jpg)  
...
![R GUI image](ch4jpg/ch4_fig17.jpg)  
...
![R GUI image](ch4jpg/ch4_fig18.jpg)Figure 7. Density plot; median in green and mean in red  
...
```
![R GUI image](ch4jpg/ch4_fig19.jpg)  

which returns the value of the range  

**Variance** – A positive value indicating deviation from the mean:![R GUI image](ch4jpg/ch4_fig20.jpg)  
...
![R GUI image](ch4jpg/ch4_fig21.jpg)

**Standard Deviation** – The square root of the variance:![R GUI image](ch4jpg/ch4_fig22.jpg)  
...
![R GUI image](ch4jpg/ch4_fig23.jpg)  

**Coefficient of Variation** (CV) – A relative (i.e. unitless) measure of standard deviation:![R GUI image](ch4jpg/ch4_fig24.jpg)  
...
![R GUI image](ch4jpg/ch4_fig25.jpg)  
...
![R GUI image](ch4jpg/ch4_fig26.jpg)  
...
![R GUI image](ch4jpg/ch4_fig27.jpg)  
...
![R GUI image](ch4jpg/ch4_fig28.jpg)Figure 8. Boxplot description (Seltman, 2009)  
...
![R GUI image](ch4jpg/ch4_fig29.jpg)Figure 9. Box plot of sand by horizon  
...
![R GUI image](ch4jpg/ch4_fig30.jpg)Figure 10. Box plot of sand by landuse.  
...
![R GUI image](ch4jpg/ch4_fig31.jpg)Figure 11. QQplot  
...
![R GUI image](ch4jpg/ch4_fig32.jpg)  
...
![R GUI image](ch4jpg/ch4_fig35.jpg)Figure 12. Sample histograms    

Occasionally distributions are Uniform, or nearly so:  

![R GUI image](ch4jpg/ch4_fig36.jpg)Figure 13. Uniform distribution  
...
![R GUI image](ch4jpg/ch4_fig37.jpg)  
...
Using the sample data. the default test uses the Shapiro-Wilk’s method:  
...
![R GUI image](ch4jpg/ch4_fig38.jpg)  
...
![R GUI image](ch4jpg/ch4_fig39.jpg)  

The D’Agostino test returns:  

```{r, eval=FALSE}
dagoTest(sand$sand)
```

![R GUI image](ch4jpg/ch4_fig40.jpg)  
...
![R GUI image](ch4jpg/ch4_fig41.jpg)Figure 14. Skewed distribution  
...
![R GUI image](ch4jpg/ch4_fig42.jpg)  
...
![R GUI image](ch4jpg/ch4_fig43.jpg)Figure 15. Rose Diagram  
...
![R GUI image](ch4jpg/ch4_fig44.jpg)  
...
![R GUI image](ch4jpg/ch4_fig45.jpg)
...
![R GUI image](ch4jpg/ch4_fig54.jpg)Figure 16. Scatter Plot  
...
![R GUI image](ch4jpg/ch4_fig55.jpg)  
...
![R GUI image](ch4jpg/ch4_fig56.jpg)  
