...
-   Functions that return *tabular data* which can be *upgraded* to spatial data:
    ...
    -   [`fetchNASIS()`](http://ncss-tech.github.io/AQP/soilDB/fetchNASIS-mini-tutorial.html): NASIS "site" data contain longitude, latitude

    -   [`fetchLDM()`](http://ncss-tech.github.io/soilDB/reference/fetchLDM.html): KSSL "site" data from Lab Data Mart contain longitude, latitude coordinates

    -   [`fetchKSSL()`](http://ncss-tech.github.io/AQP/soilDB/KSSL-demo.html): KSSL "site" data from SoilWeb contain longitude, latitude coordinates coordinates
