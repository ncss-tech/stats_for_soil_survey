...
Logical values in R encode one of three constant values: `TRUE` or `FALSE`, or missing (`NA`).
...
``` r
order_lgl <- taxorder %in% c("alfisols", "inceptisols")
subgroup_lgl <- !grepl("duri", taxsubgrp)
combined_lgl <- order_lgl & combined_lgl
