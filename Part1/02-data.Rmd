...
We call this process _cross tabulation_. 
...
As expected `gopheridge` the vast majority of pedons are _Loamy-skeletal Ultic Haploxeralfs_.
...
q <- "SELECT siteiid as siteiid, peiid, usiteid as upedonid, obsdate, soitemp, soitempdep 
       FROM site_View_1
