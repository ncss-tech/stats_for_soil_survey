...
We will use the [`pak` package](https://pak.r-lib.org/) for easy and efficient package installation and updates to the suite of packages needed for the book ([Part 1](https://ncss-tech.github.io/stats_for_soil_survey/book/index.html) and [Part 2](https://ncss-tech.github.io/stats_for_soil_survey/book2/index.html)) and exercises .
...
packages <- c(
    # soil
    "aqp", "soilDB", "sharpshootR", "soiltexture", "SoilTaxonomy",
    # gis
    "raster", "sp", "sf", "terra", "gdalUtilities", "rmapshaper",
    "rgrass", "RSAGA", "exactextractr", "fasterize", "RANN",
    # data management
    "dplyr", "tidyr", "devtools", "roxygen2", "Hmisc", "circular", "DT", "remotes", "DescTools", "dendextend", 
    # databases
    "DBI", "odbc", "RSQLite",
    # graphics
    "ggplot2", "latticeExtra", "tactile", "maps", "spData", "tmap", "kableExtra", "corrplot", "farver",
    "mapview", "ggmap", "ggspatial", "plotrix", "rpart.plot", "visreg", "diagram", "GGally", "igraph",
    # modeling
    "car", "rms", "randomForest", "ranger", "party", "ROCR", "survey",
