...
horizons(loafercreek) <- loafercreek %>%
  horizons() %>%
  mutate(
    thk = hzdepb - hzdept
    ) %>%
...
The `ggplot2 geoms` all for the incorporation of weights using the `weight` argument in the `aes()` function, where appropriate.
