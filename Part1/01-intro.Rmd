...
2.  Install the FedData R package from CRAN and [GitHub](https://github.com/ropensci/FedData). 
3.  Load the FedData R package and read the help file for the `get_ssurgo()` function within the FedData package. What is the 1st input/argument? 
4.  Save your R script and forward to your mentor.
