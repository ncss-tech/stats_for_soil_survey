...
Logical values encode one of two possible values (`TRUE` or `FALSE`) and are interpreted via [logical operators](https://stat.ethz.ch/R-manual/R-devel/library/base/html/Logic.html). Some of the more common operators are demonstrated in the following figure. Logical operators can be combined using parenthesis to describe complex subsetting criteria.
...
See [Chapter 2](#logical-operators-detail) for a more detailed description.
