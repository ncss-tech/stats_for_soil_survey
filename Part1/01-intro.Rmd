...
3.  Filter the legend table for rows where the `ssastatus == "Out-of-date"` to find the soil survey areas that need update. Inspect the result to find the `areasymbol` values.
