...
# completely unstructured data = noise
set.seed(42)
x1 <- matrix(rnorm(.n * 10, mean = 0, sd = 0.1), ncol = 10)

# data with some structure, still noisy
set.seed(42)
x2 <- rbind(
...
par(mfcol = c(1, 2))
plot(mds1$points, pch = 16, asp = 1, xlab = 'nMDS Axis 1', ylab = 'nMDS Axis 2', main = 'X1', las = 1, cex = 0.66)

plot(mds2$points, pch = 16, asp = 1, xlab = 'nMDS Axis 1', ylab = 'nMDS Axis 2', main = 'X2', las = 1, cex = 0.66)
```

Shepard plots.
```{r fig.width = 8.5, fig.height = 5}
par(mfcol = c(1, 2))
plot(shep1, pch = ".", asp = 1, xlab = 'Original Distance', ylab = 'nMDS Distance', main = 'X1: Shepard Diagram\n2 dimensions', las = 1)
lines(shep1$x, shep1$yf, type = "S", col = 2, lwd = 2)
abline(0, 1, col = 4, lwd = 2, lty = 2)

plot(shep2, pch = ".", asp = 1, xlab = 'Original Distance', ylab = 'nMDS Distance', main = 'X2: Shepard Diagram\n2 dimensions', las = 1)
