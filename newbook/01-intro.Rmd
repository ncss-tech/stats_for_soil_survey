...
Text files are a preferable format for storing and transferring small datasets.
...
# get map units
mu  <- get_mapunit_from_NASISWebReport(areasymbol = "IN%")

# get components

co  <- get_component_from_NASISWebReport(projectname = "MLRA 111A - Aquolls%") 
