...
# make a plot
plot(mydata$x, mydata$y) # This is a comment
```
...
<!--
# we could perhaps revisit this as a fun webinar like "get to know R with Rcmdr" -- as a way for people to dip their toe in and learn some new fun ways of looking at things -- but it does not cover needs of this course and IMO it just distracts/gives some people false hope of not having to get into a script/command line/reproducible workflow. -AGB
