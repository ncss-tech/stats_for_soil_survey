...
knitr::opts_chunk$set(class.source = "codeBlock", class.output = "outputBlock",
...
2. Load a project table from `mlrassoarea = "2-SON"` and `fiscalyear = 2021`, and a mapunit table from `areasymbol = c("CA630", "CA649")`.
...
5. Aggregate the total acreage of hydric soils each soil survey area.
6. Join your filtered project table to the mapunit table using a left join by `"nonmlrassarea" = "areasymbol"`.
