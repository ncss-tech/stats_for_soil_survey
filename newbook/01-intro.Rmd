...
It is a good idea to include comments in your code, so both yourself and others can understand what you were doing in the future. Each line with a comment starts with `#`. 

In RStudio, you can use `#` comments to create an "outline" for your source documents. Multiple `#` signs increase the depth of the hierarchy.  ending the line with four hyphens indicates that it should be included in the outline. The source file outline using comments regular _.R_ source files  is analogous to the [Markdown](https://www.markdownguide.org/basic-syntax/) syntax used for headers in R Markdown.
...
Download the sand Excel dataset from GitHub at [https://github.com/ncss-tech/stats_for_soil_survey/raw/master/data/Pre-course/R_sand/sand_example.xlsx](https://github.com/ncss-tech/stats_for_soil_survey/raw/master/data/Pre-course/R_sand/sand_example.xlsx)
