...
1. Load the "tahoe\_lidar\_highesthit.tif" dataset in the `gdalUtils` package (i.e. `tahoe <- raster::raster(system.file("external/tahoe_lidar_highesthit.tif", package="gdalUtils"))`) or use your own data set.
