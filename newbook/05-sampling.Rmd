...
1. Load the "tahoe\_lidar\_highesthit.tif" dataset in the `gdalUtilities` package (i.e. `tahoe <- raster::raster(system.file("extdata/tahoe.tif", package = "gdalUtilities"))`) or use your own data set.
