...
fs <- cscs(df, vars = c("x", "y"), n =  15)
fs_sf <- st_as_sf(fs, coords = c("x", "y"))
...
library(terra)
source("C:/workspace2/github/ncss-tech/stats_for_soil_survey/exercises/fcsc.R")
