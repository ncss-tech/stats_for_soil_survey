...
Another way you can view the data is to export a shape file from R.  For further information, see this tutorial: [**Export Pedons to Shapefile**](http://ncss-tech.github.io/AQP/soilDB/export-points-from-NASIS.html).
...
# AOI defined "by-hand"
# could also be an sp or sf object
a <- list(
  aoi = c(-121, 37, -120, 38),
  crs = '+init=EPSG:4326'
)
...
r1 <- ISSR800.wcs(aoi = a, var = 'texture_025cm')

# get pH, 0-25cm
r2 <- ISSR800.wcs(aoi = a, var = 'ph_025cm')
...
# try 
m1 <- mapview(texture_025cm, map.types = "Esri.WorldImagery", legend = TRUE, na.color = NA,)
m2 <- mapview(ph_025cm, map.types = "Esri.WorldImagery", legend = TRUE, na.color = NA)
