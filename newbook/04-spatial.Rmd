...
* Functions that _return_ spatial data:
  ...
  + [`seriesExtent()`]() and [`taxaExtent()`]() -- extent of series and taxonomic classes derived from SSURGO (SoilWeb) in vector and raster format at 800m resolution
  
  + [`mukey.wcs()`](http://ncss-tech.github.io/soilDB/docs/reference/mukey.wcs.html) and [`ISSR800.wcs()`](http://ncss-tech.github.io/soilDB/docs/reference/ISSR800.wcs.html)
...
<!-- note: super verbose output too soon, we cover in detail later
```{r, eval=FALSE}
...
### EXERCISE 1: `mapview` with your own data
 ...
 * _EPSG_: `4326` / _PROJ.4_:`+proj=longlat +datum=WGS84` - geographic, WGS84 datum (NASIS Standard)
 ...
 * _EPSG_: `6350` / _PROJ.4_: `+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=23.0 +lon_0=-96 +x_0=0 +y_0=0 +datum=NAD83 +units=m +no_defs` - Albers Equal Area CONUS (gSSURGO)
