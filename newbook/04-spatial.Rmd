...
All of the details of this could fill several books! And it does! A great resource that provides some comparisons of the major tools for this purpose is [Making Maps with R](https://bookdown.org/nicohahn/making_maps_with_r5/docs/introduction.html). 

_Making Maps with R_ shows similar processes using 5 different packages that have different focuses and applications: `tmap`, `ggplot2`, `mapview`, `mapdeck` and `leaflet`
