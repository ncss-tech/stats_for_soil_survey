...
In many ways the SPC is more adaptable than the NASIS Pedon concept, strictly speaking. It can "contain" aggregations of any relevant parts of any soil data schema (table and column structure). Through this mechanism, it can be a _mediator_ between formats and algorithms.
...
Hmisc::dotchart2(lf[1:pmin(10, length(lf))], col='black', xlim = c(0, max(lf)), cex.labels = 0.75)
```
...
diagnosticPropertyPlot(mt663err, v, k = 5, 
                       grid.label = 'site_id', 
