...
```{r distribution comparison, echo=FALSE, fig.dim = c(8, 4), eval=TRUE}
data(metadata)
...
```{r, echo=FALSE, purl=FALSE, fig.dim = c(8, 4), eval=TRUE}
# scatter plot
...
```{r, purl=FALSE, echo=FALSE, fig.dim = c(8, 4), eval=TRUE}
...
s <- aqp::slice(loafercreek, 0:100 ~ clay + phfield + total_frags_pct)
