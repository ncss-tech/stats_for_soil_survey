...
packages <- c("aqp", "soilDB", "Rcmdr", "raster", "rms", "randomForest", "shape", "shapefiles", "sp", "spatial", "plyr", "lattice", "circular", "markdown", "SSOAP", "rpart", "sharpshootR", "ggplot2", "rgdal", "knitr", "reshape2", "caret", "dplyr", "printr", "cluster", "ape", "RColorBrewer", "latticeExtra", "plotrix")
ipak(packages)
