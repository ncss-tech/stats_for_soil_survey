...
opts_chunk$set(message=FALSE, warning=FALSE, background='#F7F7F7', fig.align='center', fig.retina=2, dev='png', tidy=FALSE, verbose=FALSE, antialias='cleartype', cache=TRUE)
...
#### K-means
```{r, fig.width=9, fig.height=9, htmlcap="k-means function with default settings"}
...
```{r, fig.width=9, fig.height=9, htmlcap="k-means function after increasing the max number of random starts and iterations"}
par(mfrow=c(3,3), mar=c(1,1,1,1))
for(i in 1:9) {
