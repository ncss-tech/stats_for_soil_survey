...
# add original obs
points(sp4.scaled$Mg, sp4.scaled$Ca, bg=cols, col='black', cex=1, pch=21)

# legend
legend('topright', legend=c('Observation', 'Medoid'), pch=c(21, 0), lwd=c(1,2), pt.cex=c(1, 3), lty=NA, bty='n', cex=1.25)
```
