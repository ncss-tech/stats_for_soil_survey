...
Similarity among individuals is more conveniently expressed (why?) as distance, or dissimilarity. In the simplest case, dissimilarity can be computed as the Euclidean distance between individuals in property-space.

```{r, echo=FALSE, fig.width=5, fig.height=5}
par(mar=c(5,5,1,1))
plot(clay ~ sand, data=ex, las=1, type='n', xlim=c(10, 60), ylim=c(10, 60))
grid()
