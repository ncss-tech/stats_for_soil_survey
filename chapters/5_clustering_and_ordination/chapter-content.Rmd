...
**TODO**: 
  * [K-mean: important limitations / strategies](http://varianceexplained.org/r/kmeans-free-lunch/)
  * medoids are actual observations, centroids are hypothetical
...
```{r}
# overlay slope values
par(mar=c(1,1,1,1))
fig <- ordiplot(nmds, type='none', cex.axis=0.75, axes=FALSE)
abline(h=0, v=0, lty=2, col='grey')
text(fig, "sites", cex=0.65, font=2, col=site.colors)
ordisurf(fig, x.wide$slope, add=TRUE, col='black')
title('Map Unit Terrain Signatures')
```
