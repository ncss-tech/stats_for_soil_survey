...
# get previous version of sharpshootR
...
```{r eval=FALSE}
# load previously installed package into the current session
library(soilDB)
...
# Proof
Follow the one line example below, copy the output, and submit the results to Tom D'Avello. This will help us to verify that all of the required packages have been installed.
