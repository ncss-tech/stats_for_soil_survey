...
# temporary CRAN fix - get previous version of soilDB
install.packages('https://cran.r-project.org/src/contrib/Archive/soilDB/soilDB_2.4.1.tar.gz', repo=NULL)

# temporary CRAN fix - get previous version of caTools
install.packages('https://cran.microsoft.com/snapshot/2019-04-15/bin/windows/contrib/3.6/caTools_1.17.1.2.zip', repo=NULL)
```
...
You only need a few pedons at a minimum for this demo, but too many (say, >20) will make the example profile plot cluttered.
