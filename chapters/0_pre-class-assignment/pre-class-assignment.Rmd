...
packages <- c(
  ...
  # data management
  "RODBC", "plyr", "dplyr", "reshape", "reshape2", "stringr", "stringi", "devtools", "httr", "circular", "Rcpp", "knitr", "markdown",
  # graphics
  "latticeExtra", "ggplot2", "maps", "mapview", "RColorBrewer", "plotrix", "rpart.plot",
  # modeling
