...
## list of packages
packages <- c("aqp", "soilDB", "sharpshootR", "circular", "Rcmdr", "fBasics", "rms", "randomForest", "rpart", "caret", "knitr", "printr", "markdown", "raster", "rgdal", "sp", "spatial", "shape", "shapefiles", "plyr", "dplyr", "reshape2", "httr", "cluster", "ape", "lattice", "latticeExtra", "ggplot2", "RColorBrewer", "plotrix", "rpart.plot")
