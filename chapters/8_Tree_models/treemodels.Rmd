...
# CHAPTER 8: TREE-BASED MODELS  
 ...
 - [8.0 Introduction](#intro) 
 - [8.1 Classification and Regression Trees](#cart)
    - [Exercise 1: rpart](#ex1)
 - [8.2 Random Forest](#rf) 
    - [Exercise 2: randomForest](#ex2)
 - [8.3 Prediction using Tree-based Models](#predict)     
 - [8.4 Summary](#summary) 
 - [8.5 Additional Reading](#additional) 
 
##<a id="intro")></a>8.0  Introduction
...
### <a id="ex2")></a>Exercise 2: randomForest
...
##<a id="predict")></a>8.3 Prediction using Tree-based Models
...
##<a id="additional")></a>8.5 Additional Reading
