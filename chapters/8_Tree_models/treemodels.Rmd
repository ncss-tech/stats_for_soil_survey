...
Before we dive in to building tree models, let's first import and examine the dataset in R.  
...
```{r}
boxplot(Otot~spodint, data=soildata, xlab="spodic intensity", ylab="total O horizon thickness (cm)") #do you see any patterns?
...
numeric<-data.frame(soildata[, c(5:8, 17, 21:22, 25, 27:50)]) #combine numeric columns into a new data frame
names(numeric) 
...
### 8.1.3 Exercise 1
Examine the **soildata** shapefile and environmental covariate data in ArcGIS. Come up with a theory of which possible covariates might be useful for predicting spodic intensity and total O horizon thickness. 
