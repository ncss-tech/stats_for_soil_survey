...
In R, you can save several types of files to keep track of the work you do in R. workspace, script, history, and graphics. It is important to save often because R, like other software, may crash periodically especially when working with large files. Saving your work in R can be done via command line or file menu selection.  
