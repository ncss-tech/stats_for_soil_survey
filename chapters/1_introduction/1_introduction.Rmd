...
author: Katey Yoast, Skye Wills, Stephen Roecker and Tom D'Avello 
date: "`r Sys.Date()`"
output:
  html_document:
    keep_md: yes
...
- Learn what packages are and how to install them.
- Learn how to save files in R.
