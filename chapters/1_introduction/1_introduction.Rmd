...
R and RStudio have been installed on all computers on which NASIS is installe. R and RStudio are typically updated and CCE approved once a year. The versions on USDA machines may be one to three releases behind the latest version available for public download. Having an outdated version of R  rarely creates a problem, although warnings may appear.  
