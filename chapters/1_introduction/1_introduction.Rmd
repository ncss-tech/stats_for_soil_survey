...
First, create an example file by copying the contents below, starting with "location" and ending with "25." Paste the content into Notepad and save the file as sand_example.txt in the C:\workspace folder.  
