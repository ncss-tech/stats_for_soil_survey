...
1. [Reproducible Research](http://christophergandrud.github.io/RepResR-RStudio/) (*self-documenting, repeatable*)
    + repeatable: 
        + code + output in a single document [*(trust but verify)*](https://www.youtube.com/watch?time_continue=1&v=s3JldKoA0zw)
...
```{r, echo=FALSE, eval=TRUE, fig.dim=c(10, 5)}
library(soilDB)
data("loafercreek")
