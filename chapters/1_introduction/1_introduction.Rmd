...
If you want to change something slightly, edit the command line in the script window, select the entire command, and click **Submit.** Note that commands in the R Commander script window are not preceded by an angle bracket (>) as they are in R Console.  
...
Navigate back to the **Statistics** menu and select **Means - One-way ANOVA.** If you wish to reuse your model, give it a unique name in **Enter name for model.** Select **landuse** in the **Groups** field and set **sand** as the Response Variable. Click **OK.** 
...
Note that the figure above shows a fourth window named "Untitled1." This is an R script window and is very similar to the one we looked at in RGui. To open the R script window in RStudio, click the **File** drop-down menu, then **New File,** and then **R Script.** 
