...
Navigate to RStudio from your start menu. When you open RStudio, you will see your screen split into quadrants:  
...
Rstudio Support has examples in the [Knowledge Base](https://support.rstudio.com/hc/en-us/sections/200107586-Using-RStudio) that will help you use RStudio.   
...
To learn more about the function you are using and the options/arguments available; take advantage of some of the help functions in RStudio. **Place your cursor next to the command prompt (>) in the console (lower left).**  
**Type: > hist**  
