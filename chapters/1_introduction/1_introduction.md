...
Try some of the examples included at the end of the soilDB {soilDB} documentation, from the previous search, or from the [fetchKSSL demo](http://ncss-tech.github.io/AQP/soilDB/KSSL-demo.html).  
