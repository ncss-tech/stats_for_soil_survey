...
For a more in-depth review of data types in R, please review the [**Chapter 2a Appendix - Data Types**](http://ncss-tech.github.io/stats_for_soil_survey/tree/master/chapters/2_data/2a_appendix_data_types.html).  
...
## setup local NASIS with query for:
# user site ID ~ %MT647%

## get soil temp measurements
q <- "
...
This document can be regenerated by loading sites and pedon from the MT647 survey area from the '4-MIS Pedons' NASIS group.
