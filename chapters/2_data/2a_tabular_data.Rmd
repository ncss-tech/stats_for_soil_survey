...
```{r owndata_i_gopher, eval=FALSE, echo=TRUE, results='show', warning=FALSE}
# load required libraries
library(aqp)
library(soilDB)
library(plyr)
...
```{r owndata_j3, eval=TRUE, echo=TRUE, results='show', warning=FALSE}
