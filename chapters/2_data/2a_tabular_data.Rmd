...
## 2.0.2 Importance of Pedon Data
...
### 2.0.2.1 Some Issues With Pedon Data
...
## 2.1.1 Classes of Objects Used in R
...
#### 2.1.1.1.1 Referencing elements of a vector
...
#### 2.1.1.1.2 Vectorized evaluation: Implicit looping
...
#### 2.1.1.2.1 Referencing within dataframes
...
## 2.2.1 Set Up an Open Database Connectivity (ODBC) Connection to NASIS  
...
## 2.2.2 What is the SoilDB Package, and What Does It Do?
...
### 2.2.2.1 Additional Convenience Functions in the SoilDB Package
...
### 2.2.2.2 Data Checks Run by the `fetchNASIS()` Function
...
#### 2.2.2.2.1 How can you find the site ID's where these errors occur and fix them in NASIS?
...
### 2.2.2.3 Options That Can Be Set Within fetchNASIS()
...
## 2.2.3 Structure of Pedon Data in a Soil Profile Collection (SPC)

### 2.2.3.1 The `Gopheridge` Sample Dataset
...
#### 2.2.3.1.1 Quickly generate sketches from a `SoilProfileCollection` object
...
#### 2.2.3.1.2 Subset example of the data in the site-level portion of the SPC
...
#### 2.2.3.1.3 Subset example of the data in the horizon-level portion of the SPC
...
#### 2.2.3.1.4 Follow along with your own data
...
## 2.2.4 Viewing Pedon Locations
### 2.2.4.1 Plotting Geographic Data Directly in R
...
### 2.2.4.2 Displaying Pedon Data in Google Earth
...
### 2.2.4.3 Exporting Pedon Data to an ESRI Shapefile
...
#### 2.2.4.3.1 Follow along with your own data
...
### 2.3.1.1 Filtering Data Using Pattern Matching
...
#### 2.3.1.1.1 Additional syntax options for REGEX pattern matching
...
### 2.3.1.2 Filtering Data by Specifying a Criteria Using the `which()` Function
...
#### 2.3.1.2.1 Additional syntax options for use in `which()` criteria
...
### 2.3.1.3 Extracting Site and Horizon Data
...
### 2.3.1.4 Review of Data Checks Run by `fetchNASIS()`
...
#### 2.3.2.2.1 Example using the Gopheridge sample dataset
...
#### 2.3.2.2.2 Follow along with your own data
...
## 2.3.3 Getting Additional Data: Extended Data Functions
...
### 2.3.3.1 Deriving Thicknesses of Diagnostic Features

#### 2.3.3.1.1 Boolean diagnostic feature columns in the site data
...
#### 2.3.3.1.2 Follow along with your own data
...
### 2.3.3.2 Diagnostic Feature Diagrams
...
#### 2.3.3.2.1 Follow along with your own data
...
## 2.3.4 Common Challenges in Working with Pedon Data
...
### 2.3.4.1 Meeting the Challenges
