...
Check MLRA polygons, how many features per MLRA symbol? Note that some MLRA have more than one polygon.
```{r}
table(mlra$MLRARSYM)
```

Convert polygon area from square meters to acres.
```{r}
...
Graphical summary of the results. This requires reshaping our results from "wide" to "long" format.
