...
The `velox` package provides an interesting approach to sampling raster values that intersect with vector features, *as long as the raster data fit into available memory*. For example, sampling all of the raster values that overlap with the estimated extent of the San Joaquin soil series (about ~ 1 million acres) takes about 2.5 seconds.
