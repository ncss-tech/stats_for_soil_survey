...
The `velox` package provides an interesting approach to sampling raster values that intersect with vector features, *as long as the raster data fit into available memory*. For example, sampling all of the raster values that overlap with the estimated extent of the [San Joaquin](https://casoilresource.lawr.ucdavis.edu/see/#san joaquin) soil series (about ~ 458,00 acres) takes about 0.8 seconds.
