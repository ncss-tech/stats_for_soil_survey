...
See the [sp gallery](https://edzer.github.io/sp/) and vignettes [1](https://cran.r-project.org/web/packages/sp/vignettes/intro_sp.pdf) [2](https://cran.r-project.org/web/packages/sp/vignettes/over.pdf) for a much more detailed description of the `sp` classes. Currently, much of the functionality of the `sp` package is being re-imagined as part of the `sf` library--still a work in progress.
