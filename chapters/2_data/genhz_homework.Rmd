...
When it comes time, you will replace this next block of code with code to get your own data. If you use `fetchNASIS()` that IT produces useful QC output that may be relevant to your analysis. [Chapter 2a, Section 4.2.5: fetchNASIS QC output](http://ncss-tech.github.io/stats_for_soil_survey/chapters/2_data/2a_tabular_data.html#425_review_of_data_checks_run_by_fetchnasis())
