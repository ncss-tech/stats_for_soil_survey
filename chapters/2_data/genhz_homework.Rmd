...
Then you will apply the same strategy to NASIS pedons from _your_ area of repsonsibility. That is, you will replace this next block of code with code tog get your own data, adn everything else will be essentially the same unless you choose to change it.
