...
crosby <- fetchSDA_component(WHERE = "muname LIKE 'Crosby%' AND majcompflag = 'Yes'")
spc <- crosby
c2 <- subsetProfiles(spc, s = "cokey == '16059045'")
c_h <- horizons(c2)
...
test4$erocl <- factor(test4$erocl, levels = levels(test4$erocl), labels = c("None - deposition", "Slightly", "Moderately", "Severely", "Extremely"))
