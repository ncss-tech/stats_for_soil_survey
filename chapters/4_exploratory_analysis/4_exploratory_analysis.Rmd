...
Typo errors such as these are commonly found with old pedon data in NASIS.

## Exercise: fetch and inspect

- Load the gopheridge dataset found within the soilDB package and inspect the dataset. 
- Apply the generalized horizon rules.
