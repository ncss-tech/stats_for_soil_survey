...
histboxp(x=s.df$MAAT, group=s.df$mlra, sd=TRUE, bins=100, xlab='Mean Annual Air Temperature (deg C)')

# interactive exploration of the Effective PPT distributions by MLRA
histboxp(x=s.df$eff.PPT, group=s.df$mlra, sd=TRUE, bins=100, xlab='Annual Sum of Monthly PPT - PET (mm)')
```
