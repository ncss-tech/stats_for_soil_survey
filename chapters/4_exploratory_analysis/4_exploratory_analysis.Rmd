...
# ))
# 
test <- read.csv("C:/workspace2/github/stats_for_soil_survey.git/trunk/data/ca794_zonal.csv") # import the results
...
load(file = "C:/workspace2/github/stats_for_soil_survey.git/trunk/data/ch2_sample.Rdata")
