...
# load("C:/workspace2/wv_raster.RData")
# glm_r <- raster("C:/workspace2/spodic_pres_GLM1.img")
...
caret::confusionMatrix(table(comp$pred, comp$argillic), positive = "TRUE")
...
temp <- subset(comp, argillic == TRUE) %>%
  group_by(cluster2) %>%
  summarize(
...
# Examine the coefficients, stored in log odds
summary(argi_glm)
