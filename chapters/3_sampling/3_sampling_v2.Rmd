...
x1 <- seq(12, 20, 0.1)
test1 <- dnorm(x1, mean = 16, sd = 2)

x2 <- seq(15, 23, 0.1)
test2 <- dnorm(x2, mean = 19, sd = 2)

summary(c(x1, x2))

plot(x1, test1, type = "l", xlim = range(c(x1, x2)), main = "Overlapping Populations", xlab = "Clay %")
lines(x2, test2)
...
str <- spsample(test, n = 23, type = "stratified", iter = 1000)[1:20] # take a small stratified random sample
