...
From the figure above you can see how difficult it is to separate two overlapping populations (e.g. horizons). Also the number of samples required doubles with a 1 unit increase in the standard deviation. This simplistic example, while enlightening, is hard to implement in practice and for our purposes, only serves as a theoretical exercise. 
