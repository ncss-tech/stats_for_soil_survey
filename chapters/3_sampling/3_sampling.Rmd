...
```{r clhs, echo=FALSE, eval=FALSE}
data(volcano) # http://geomorphometry.org/content/volcano-maungawhau
volcano <- raster(as.matrix(volcano), crs = CRS("+init=epsg:27200"), xmn = 2667405, xmx = 2667405 + 61*10, ymn = 6478705, ymx = 6478705 + 87*10)
volcano <- flip(volcano, direction = "y")
volcano <- flip(volcano, direction = "x")
slope <- terrain(volcano, opt = "slope", unit = "radians")
```
