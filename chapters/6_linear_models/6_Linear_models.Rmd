...
pedons2 <- site(pedons)
            ...
            ### DOESN'T LOOK LIKE THERE ARE ANY COORDINATES IN THE DATA WE LOADED!!!
#slot(pedons2, "site") <- s # this is dangerous, but something needs to be fixed in the site() setter function
idx <- complete.cases(pedons2[c("x", "y")]) # create an index to filter out pedons with missing coordinates
pedons2 <- pedons2[idx]
