...
## Dxy           0.7068   0.7072  0.7050   0.0022          0.7046 10
## R2            0.3202   0.3210  0.3177   0.0032          0.3170 10
## Intercept     0.0000   0.0000 -0.0594   0.0594         -0.0594 10
## Slope         1.0000   1.0000  1.0251  -0.0251          1.0251 10
## Emax          0.0000   0.0000  0.0168   0.0168          0.0168 10
## D             0.1684   0.1688  0.1550   0.0137          0.1547 10
## U            -0.0017  -0.0019 -0.0017  -0.0002         -0.0015 10
## Q             0.1701   0.1707  0.1567   0.0140          0.1562 10
## B             0.0755   0.0754  0.0765  -0.0011          0.0765 10
## g             3.7232   3.7375  3.8089  -0.0714          3.7946 10
## gp            0.1311   0.1312  0.1279   0.0033          0.1278 10
```
...
<img src="005-glm_files/figure-html/effects-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="005-glm_files/figure-html/effects-2.png" width="672" style="display: block; margin: auto;" />
...
train2 <- select(train2, z:mast, pc_1:u, ndvi:gsi, shallow)
```
