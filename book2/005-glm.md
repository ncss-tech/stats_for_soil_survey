...
<img src="005-glm_files/figure-html/logit-function-1.png" alt="" width="672" />
...
<img src="005-glm_files/figure-html/logit-example-1.png" alt="" width="768" />
...
<img src="005-glm_files/figure-html/surface-1.png" alt="" width="672" style="display: block; margin: auto;" />
...
<img src="005-glm_files/figure-html/spatial-1.png" alt="" width="768" style="display: block; margin: auto;" />
...
<img src="005-glm_files/figure-html/diag-1.png" alt="" width="672" style="display: block; margin: auto;" />

```{.r .codeBlock}
termplot(fit_glm, partial.resid = TRUE, col.res = "black", pch = 16)
```

<img src="005-glm_files/figure-html/diag-2.png" alt="" width="672" style="display: block; margin: auto;" /><img src="005-glm_files/figure-html/diag-3.png" alt="" width="672" style="display: block; margin: auto;" /><img src="005-glm_files/figure-html/diag-4.png" alt="" width="672" style="display: block; margin: auto;" /><img src="005-glm_files/figure-html/diag-5.png" alt="" width="672" style="display: block; margin: auto;" /><img src="005-glm_files/figure-html/diag-6.png" alt="" width="672" style="display: block; margin: auto;" />
...
## Dxy           0.7068   0.7071 0.6982   0.0090          0.6978  0.3733 0.9184 10
## R2            0.3202   0.3212 0.3201   0.0011          0.3191  0.0604 0.5278 10
## Intercept     0.0000   0.0000 0.0331  -0.0331          0.0331 -1.0702 1.9550 10
## Slope         1.0000   1.0000 1.0832  -0.0832          1.0832  0.2288 2.4395 10
## Emax          0.0000   0.0000 0.1223  -0.1223          0.1223 -0.0625 0.4603 10
## D             0.1684   0.1689 0.1582   0.0107          0.1577  0.0359 0.3765 10
## U            -0.0017  -0.0019 0.0030  -0.0049          0.0032 -0.0359 0.0469 10
## Q             0.1701   0.1708 0.1552   0.0156          0.1545 -0.0100 0.3313 10
## B             0.0755   0.0754 0.0769  -0.0015          0.0770  0.0105 0.1261 10
## g             3.7232   3.7296 4.0377  -0.3081          4.0313  0.5635 9.0701 10
## gp            0.1311   0.1312 0.1278   0.0035          0.1276  0.0351 0.2234 10
```
...
<img src="005-glm_files/figure-html/unnamed-chunk-6-1.png" alt="" width="672" style="display: block; margin: auto;" />
...
<img src="005-glm_files/figure-html/unnamed-chunk-6-2.png" alt="" width="672" style="display: block; margin: auto;" />
...
<img src="005-glm_files/figure-html/effects-1.png" alt="" width="672" style="display: block; margin: auto;" />
...
<img src="005-glm_files/figure-html/effects-2.png" alt="" width="672" style="display: block; margin: auto;" />
...
plot(r[[1]], col = hcl.colors(10))
```

<img src="005-glm_files/figure-html/unnamed-chunk-7-1.png" alt="" width="672" style="display: block; margin: auto;" />

```{.r .codeBlock}
# argillic Shannon Entropy
plot(r[[2]], col = hcl.colors(10))
```

<img src="005-glm_files/figure-html/unnamed-chunk-7-2.png" alt="" width="672" style="display: block; margin: auto;" />
