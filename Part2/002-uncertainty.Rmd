...
df$pred <- predict(df_lm)
pi <- predict(df_lm, new, interval = "prediction")
ci <- predict(df_lm, new, interval = "confidence")

i <- rbind(
  data.frame(Interval = "PI", pi, new), 
  data.frame(Interval = "CI", ci, new)
  )
