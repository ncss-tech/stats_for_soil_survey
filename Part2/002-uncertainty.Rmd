...
For a more detailed explanation of the bootstrap, with examples in R, see [Nonparametric Bootstrap in R](http://users.stat.umn.edu/~helwig/notes/npboot-notes.html) by Nathaniel E. Helwig at the University of Minnesota.
...
ggplot() +
  ...
  scale_shape_manual(values = c("Squared Errors"="circle"), name = NULL) +
  scale_linetype_manual(values = c("Reference"="solid", "RMSE"="dashed", "Bias/Mean"="dotted"), name = NULL) +ylab("y") +
