...
```{r eval = TRUE, fig.width=8, fig.height=4, echo=FALSE, message=FALSE}
library(sharpshootR)
# init example data
data(sp4)
depths(sp4) <- id ~ top + bottom
...
par(mar=c(0,0,3,1))
plotProfileDendrogram(sp4, clust, dend.y.scale = 50, scaling.factor = 0.66, y.offset = 2.5, width=0.3, cex.names = 0.7, color='ex_Ca_to_Mg', col.label='Exchageable Ca to Mg Ratio', name.style = 'center-center')
```
...
```{r eval = TRUE, fig.width=10, fig.height=6}
par(mar=c(2,0,2,0))
plotProfileDendrogram(s, clust, dend.y.scale = 1, scaling.factor = 0.004, y.offset = 0.1, width=0.3, cex.names=0.45)
