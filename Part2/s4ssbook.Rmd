...
## consider adding: tidy=FALSE, verbose=FALSE, antialias='cleartype', cache=FALSE
...
<!--chapter:end:002-uncertainty.Rmd-->
...
<!--chapter:end:003-numerical-taxonomy.Rmd-->
...
<!--chapter:end:004-linear-models.Rmd-->
...
<!--chapter:end:006-treemodels.Rmd-->
...
```{r data-prep-and-function, echo = FALSE, eval = TRUE}
library(igraph)
...
```{r simulate-data, echo = FALSE, eval = TRUE}
s <- list()
n <- 1000
...
```{r make-figures, echo = FALSE, eval = TRUE}
## class probabilities
...
```{r, eval = TRUE, fig.width=10, fig.height=4, fig.cap='Probability distributions of predictions.'}
...
<!--chapter:end:appdx-class-accuracy.Rmd-->
...
<!--chapter:end:appdx-frameworks.Rmd-->
