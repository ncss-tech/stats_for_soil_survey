...
(table(map = sample$map, obs = sample$obs))
...
volcano_svy <- svydesign(ids = ~1, weights = ~wk_e, stratum = ~pred, data = test_samp21, variables = ~pred + obs)
tb <- svytable(~pred + obs, design = volcano_svy)
svyciprop()
