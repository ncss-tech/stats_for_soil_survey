...
```{r owndata_b, results='hide', eval=FALSE}
...
```{r owndata_d, results='hide', eval=FALSE}
...
```{r owndata_e, eval=FALSE, results='show', fig.width=8, fig.height=4}
# adjust margins
par(mar=c(1,0,0,1))
...
```{r owndata_f, eval=FALSE, results='show', fig.width=8, fig.height=4}
# say we wanted to look at what the variation of particle size classes are within a specific subgroup?
...
```{r owndata_g, eval=FALSE, results='show'}
...
```{r owndata_j4, eval=FALSE, echo=TRUE, results='show', warning=FALSE}
